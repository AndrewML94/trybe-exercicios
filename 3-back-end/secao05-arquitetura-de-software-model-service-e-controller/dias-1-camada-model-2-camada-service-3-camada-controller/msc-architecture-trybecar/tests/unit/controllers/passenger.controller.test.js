...
const { passencerController } = require('../../../src/controllers');
const { passengerListMock } = require('./mocks/passenger.controller.mock');
...
describe('Teste de unidade do passengerController', function () {
  describe('Listando as pessoa passageiras', function () {
    it('Deve retornar o status 200 e a lista', async function () {
      ...
      await passencerController.listPassengers(req, res);
